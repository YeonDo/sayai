    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/apis/v1/player/**", "/apis/v1/auth/login", "/apis/v1/auth/signup", "/apis/v1/auth/kakao/login", "/apis/v1/fantasy/players/import", "/apis/v1/fantasy/players/pick-owner", "/").permitAll()
